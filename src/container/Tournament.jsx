  ...
  return (
    <div className="p-6 min-h-screen">
      ...
      {showCricketCards && selectedMatch ? (
        ...
        <>
          <h2 className="text-3xl font-bold mb-6 text-start text-gray-800">{getStageTitle()}</h2>
          ...
          {currentStage === "setup" && (
            <>
              <div className="flex gap-5 mb-6 justify-start">
                ...
                <button
                  onClick={addTeam}
                  className="bg-gray-500 text-white px-6 py-1 rounded-lg hover:bg-gray-600 transition-colors cursor-pointer"
                >
                  Add Team
                </button>
              </div>
              ...
              <div className="mb-6">
                <h3 className="text-xl font-semibold mb-3 text-start">Teams ({teams.length}/8):</h3>
